...
#was compiled a while ago so VSC might not like it

contract norcalcustomerservices {

    string public name = "norcalcustomerservices";
    string public symbol = "NCCS";
    ...
    function norcalcustomerservices() public {
